        ...
        >
            ...
            <div className="py-8">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
                    ...
                    {/* Filters Container */}
                    <div className="rounded-2xl bg-black/60 p-6 shadow-lg border border-red-950/25 backdrop-blur-md flex flex-col md:flex-row gap-4 items-center justify-between">
                        <div className="relative w-full md:max-w-md">
                            ...
                            <input 
                                ...
                                className="w-full rounded-xl border border-red-950/30 bg-black/45 py-2.5 pl-10 pr-4 text-sm text-white focus:border-[#E8192C] focus:ring-0 focus:outline-none transition-all"
                                placeholder="Cari nama barang, kode aset, atau S/N..."
                            />
                        </div>
                        <div className="flex gap-2 w-full md:w-auto items-center">
                            <span className="text-sm font-semibold text-zinc-400 whitespace-nowrap">Filter Kategori:</span>
                            <select 
                                value={filterType}
                                onChange={(e) => setFilterType(e.target.value)}
                                className="rounded-xl border border-red-950/30 bg-[#0c0c0c] py-2 px-3 text-sm font-medium text-zinc-300 focus:border-[#E8192C] focus:ring-0 focus:outline-none transition-all"
                            >
                                            ...
                                            <tr key={asset.id} className="hover:bg-red-950/10 transition">
                                                ...
                                                <td className="py-4 text-center">
                                                    <button 
                                                        ...
                                                        className="inline-flex items-center gap-1.5 rounded-lg bg-black/40 border border-red-950/30 hover:border-red-500/30 text-gray-300 hover:text-white px-3 py-1.5 text-xs font-semibold hover:bg-red-950/20 transition-all"
                                                    >
            ...
            {qrModalOpen && selectedAsset && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                    <div className="w-full max-w-sm bg-[#0c0c0c] border border-red-950/40 rounded-3xl p-6 shadow-2xl space-y-6 text-white">
                        <div className="flex justify-between items-center pb-2 border-b border-red-950/20">
                            <h3 className="text-lg font-bold text-white font-serif">Label QR Aset Resmi</h3>
                            <button onClick={() => setQrModalOpen(false)} className="rounded-full p-1.5 text-zinc-400 hover:bg-[#1a1a1a]">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button 
                                ...
                                className="flex-1 rounded-xl bg-black/40 border border-red-950/30 hover:border-red-500/30 py-3 text-xs font-semibold text-zinc-300 hover:text-white hover:bg-[#1a1a1a] transition-all"
                            >
                                Tutup
                            </button>
                        </div>
