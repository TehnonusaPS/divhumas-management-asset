                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                    <div className="w-full max-w-md bg-[#0c0c0c] border border-red-950/40 rounded-3xl p-6 shadow-2xl space-y-5 text-white">
                        <div className="flex justify-between items-center">
                            <h3 className="text-lg font-bold text-white font-serif">Ubah Otoritas Role</h3>
                        ...
                        <form onSubmit={handleRoleChange} className="space-y-4 pt-2">
                            <div>
                                <label className="block text-xs font-bold text-zinc-400 uppercase mb-1.5">Pilih Peran Baru (Spatie Role)</label>
                                <select 
                                    value={newRole}
